...
long long song1_key1_times[] = {-1, 1000, 4500, 7000};
int w = 1;
long long song1_key2_times[] = {-1, 1500, 6000, 7500};
int a = 1;
long long song1_key3_times[] = {-1, 2000, 5000, 8500};
int s = 1;
long long song1_key4_times[] = {-1, 3000, 8000, 9000};
int d = 1;

// these represent the next time a light should turn on; technically when a button should be pressed after the song starts
unsigned long next_light_1 , next_light_2 , next_light_3, next_light_4 = 0;
...
void loop() {
    ...
    if ( millis() > next_light_2 ) {
        ...
        // TODO
        // iterate for column 2 with fastLED.h stuff; for loop
        // at 9th or 10th row in for loop, do a button check and then score stuff
    ...
    if ( millis() > next_light_3 ) {
        ...
        // TODO
        // iterate for column 3 with fastLED.h stuff; for loop
        // at 9th or 10th row in for loop, do a button check and then score stuff
    ...
    if ( millis() > next_light_4 ) {
        ...
        // TODO
        // iterate for column 4 with fastLED.h stuff; for loop
        // at 9th or 10th row in for loop, do a button check and then score stuff
    ...
    // for loop to iterate through 10 lights
    // for(int i = 0; i < 10; i++) {
